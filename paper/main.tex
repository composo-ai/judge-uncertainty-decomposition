...
%%
%% Source of the submitted 4-page paper (JUDGe poster track / TAE, NeurIPS 2026 workshops).
%%
%% Build: make -C paper

\documentclass{article}

%% Both target venues are double-blind, so dblblindworkshop is correct for the
%% submission. Switch to "final" for the camera-ready.
...
%% Author block is suppressed automatically under double-blind submission; the style file
%% substitutes "Anonymous Author(s)". Fill in for the camera-ready only.
\author{%
  Anonymous Author(s) \\
  Affiliation \\
  Address \\
